...
"""
Runtime: 32 ms, faster than 79.66% of Python3 online submissions for String to Integer (atoi).
Memory Usage: 14.4 MB, less than 22.89% of Python3 online submissions for String to Integer (atoi).
"""
